<x-layouts.app :title="__('Detalhes do Usuário')">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-3">
                        <a href="{{ route('users.edit', $user) }}" class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition-colors flex items-center">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        ...
                        <div class="space-y-3">
                            <a href="{{ route('users.edit', $user) }}" class="w-full bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition-colors flex items-center justify-center">
                                <i class="fas fa-edit mr-2"></i>
                                Editar Usuário
                            </a>
